...
package com.facecapture.prod.live2d;

import static com.facecapture.prod.live2d.LAppDefine.DEBUG_LOG_ENABLE;
import static com.facecapture.prod.live2d.LAppDefine.USE_MODEL_RENDER_TARGET;
import static com.facecapture.prod.live2d.LAppDefine.USE_RENDER_TARGET;
...
public class LAppLive2DManager {
    ...
    public void nextScene() {
        final int number = (currentModelIndex + 1) % modelDir.size();
    ...
    public LAppModel getCurrentModel() {
        return getModel(getCurrentModelIndex());
    }
