...
/** Face Detector Demo.  */
class FaceDetectorProcessor(context: Context, detectorOptions: FaceDetectorOptions?, private val onFaceDetectListener: OnFaceDetectListener? = null) :
  ...
  override fun onSuccess(faces: List<Face>, graphicOverlay: GraphicOverlay?) {
    ...
    onFaceDetectListener?.onFaceDetect(face)
