...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
  ...
  public FaceDetectorProcessor(Context context, OnFaceDetectListener onFaceDetectListener) {
    super(context);
  ...
  private FaceDetectorOptions getFaceDetectorOptions(Context context) {
...
//    }
    ...
    Face last = faces.get(faces.size() - 1);
    logExtrasForTesting(last);
    if (onFaceDetectListener != null) {
      onFaceDetectListener.onFaceDetect(last);
    }
  }
