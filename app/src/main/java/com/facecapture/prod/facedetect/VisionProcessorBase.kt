...
import com.facecapture.prod.FCApp
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  private fun processImage(
    ...
    val bitmap =
      if (PreferenceUtils.isCameraLiveViewportEnabled(FCApp.getApp())) null
    ...
    return task
      .addOnSuccessListener(
        ...
        OnSuccessListener { results: T ->
          ...
          if (!PreferenceUtils.shouldHideDetectionInfo(FCApp.getApp())) {
            graphicOverlay?.add(
